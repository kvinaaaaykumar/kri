...
const HeaderClose2 = () => {
  ...
  return (
    <header className='h-16 shadow-md bg-gradient-to-r bg-white fixed w-full z-40'>
      <div className='h-full container mx-auto flex items-center px-4 justify-between'>
        ...
        <div className='flex items-center gap-7'>
          ...
          <Link to={'/excutive'} className='text-2xl text-black lg:hidden'>
            <IoClose />
          </Link>
        </div>
      </div>
